        ...
        rx.el.main(
            ...
            rx.el.div(
                ...
                rx.el.div(
                    rx.el.table(
                        ...
                        rx.el.tbody(
                            rx.foreach(ReportState.top_clv_customers, clv_customer_row)
                        ),
            ...
            rx.el.div(
                rx.el.div(
                    ...
                    rx.el.div(
                        rx.el.span("Avg Wastage: ", class_name="text-sm text-gray-600"),
                        rx.el.span(
                ...
                rx.el.div(
                    ...
                    rx.cond(
                        ...
                        rx.el.div(
                            ...
                            rx.el.p(
                                "No wastage data available.", class_name="text-gray-500"
                            ),
                            class_name="text-center py-16",
                        ),
                        None,
            ...
            rx.el.div(
                ...
                rx.el.div(
                    rx.el.div(
                        rx.el.p("Total Invoices", class_name="text-sm text-gray-500"),
                        rx.el.p(
                    ...
                    rx.el.div(
                        rx.el.p("Taxable Sales", class_name="text-sm text-gray-500"),
                        rx.el.p(
